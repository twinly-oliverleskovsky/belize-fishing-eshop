      ...
      <AnimatedSection>
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-10">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-drift-gray font-body text-sm">
      ...
      <div className="space-y-0">
        {reviews.map((review, i) => (
          <AnimatedSection key={review.id} delay={i * 0.1}>
            <div className="py-6 border-b border-sand-medium last:border-b-0">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-3">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-body font-semibold text-deep-ocean text-sm">
                      {review.author}
                    </p>
              ...
              <p className="text-drift-gray font-body text-sm leading-relaxed pl-0 sm:pl-[52px]">
                {review.comment}
              </p>
            </div>
          </AnimatedSection>
