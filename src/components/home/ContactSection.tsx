...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-24 lg:py-32 bg-sand-medium/50">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              {contactInfo.map((item) => (
                <div key={item.title} className="flex gap-4">
                  ...
                  <div>
                    <h4 className="font-body font-semibold text-deep-ocean text-sm uppercase tracking-wider mb-1">
                      {item.title}
                    </h4>
                    {item.lines.map((line) => (
                      <p key={line} className="text-drift-gray text-sm font-body">
                        {line}
                      </p>
                    ))}
                  </div>
            ...
            {sent ? (
              <div className="flex items-center justify-center h-full">
                <div className="text-center">
                  ...
                  <h3 className="font-display text-2xl font-semibold text-deep-ocean mb-2">
                    Message Sent!
                  </h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="floating-label-group">
                  <input
                    ...
                    placeholder=" "
                    required
                    className="font-body text-deep-ocean"
                  />
