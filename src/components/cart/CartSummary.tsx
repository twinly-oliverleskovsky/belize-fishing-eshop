  ...
  return (
    <div className="bg-sand-medium rounded-2xl p-6 lg:p-8 sticky top-28">
      ...
      <div className="space-y-3 mb-6">
        <div className="flex justify-between font-body text-drift-gray">
          <span>Subtotal</span>
      ...
      <div className="border-t border-sun-gold/30 pt-4 mb-6">
        <div className="flex justify-between">
          <span className="font-body font-semibold text-deep-ocean text-lg">Total</span>
      ...
      <div className="mt-4 flex items-center justify-center gap-2 text-drift-gray text-sm font-body">
